...
- [ ] **Step 1: Implement minimal certificate helper**
...
- [ ] **Step 2: Pass signing properties to MSBuild**
...
- [ ] **Step 3: Implement two lifecycle rounds and cleanup**

Run install/launch/uninstall twice with the same package. In `finally`, remove only the
package installed by this script and verify no matching package remains.
...
- [ ] **Step 2: Protect Artifact contents**
...
- [ ] **Step 1: Review data safety and staged paths**
